        ...
        {status === 'approved' && (
          <View style={[styles.banner, styles.bannerSuccess]}>
            ...
            <View style={styles.bannerText}>
              ...
              <Text style={styles.bannerDesc}>Votre identite a ete verifiee avec succes.</Text>
            </View>
          </View>
        )}
        ...
        {status === 'rejected' && (
          <View style={[styles.banner, styles.bannerError]}>
            ...
            <View style={styles.bannerText}>
              ...
              {rejectionReason ? (
                <Text style={styles.bannerDesc}>Raison : {rejectionReason}</Text>
              ) : null}
              <Text style={styles.bannerDesc}>Vous pouvez soumettre une nouvelle demande.</Text>
            </View>
          </View>
        )}
                ...
                <View style={styles.docInfo}>
                  ...
                  {doc.file ? (
                    <View style={styles.docFileRow}>
                      ...
                      <Text style={styles.docFileName} numberOfLines={1}>{doc.file.name}</Text>
                      <TouchableOpacity
                    ...
                    <View style={styles.uploadHint}>
                      ...
                      <Text style={styles.uploadHintText}>Appuyez pour telecharger</Text>
                    </View>
                  )}
                </View>
              </TouchableOpacity>
